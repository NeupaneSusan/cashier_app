                                ...
                                Flexible(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        height: 40.0,
                                        color: Color.fromARGB(255, 26, 201, 10),
                                        child: const Center(
                                          child: Text(
                                            'Esewa Amount',
                                            style: TextStyle(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                            ...
                                            onChanged: (value) {
                                              if (value.isNotEmpty) {
                                                var a = double.parse(value);
                                                amountFlow.setAmount(6, a);
                                              } else {
                                                amountFlow.setAmount(6, 0);
                                              }
                                            },
                                            decoration: const InputDecoration(
                                                hintText: '0',
                          ...
                          Row(
                            ...
                            children: [
                              const Flexible(
                                ...
                                child: Text(
                                  "This will close your today's all transactions. You can cancel it now but after confirm you can't undo it.",
                                  style: TextStyle(
