...
printingDayClosing(printer, data) {
  ...
  printer
      .text('Esewa Payment        : ${data['total_esewa_payment'].toString()}');
  printer.text(
  ...
  printer.text('Total eSewa Amount   : Rs.${data['system_esewa_amount']}');
  ...
  printer.text(
      'eSewa Fonepay & Card : Rs.${data['system_esewa_fonepay_and_card_amount']}');
  printer.text(
...
printClosingReport(printer, data) {
  ...
  printer.text('eSewa Payment     : ${data['total_esewa_payment']}');
...
printCashCountsReport(printer, data) {
  ...
  printer.text('eSewa Amount  : Rs.${data['esewa_amount']}');
...
printingTokenForTA(printer, data, storeName, orderItem, companyInfo, isUpdate) {
  ...
  printer.text('T/W No       : ${data[0]['tw_no'].toString()}',
      styles: const PosStyles(bold: true));
  if (data[0]['tw_name'] != '') {
...
printingTokenForTAForUser(printer, data, companyInfo, isUpdate) {
  ...
  printer.text('T/W No       : ${data[0]['tw_no'].toString()}',
      styles: const PosStyles(bold: true));
  printer.text('Token No     : ${data[0]['token_no'].toString()}',
      styles: const PosStyles(bold: true));
  if (data[0]['tw_name'] != '') {
    printer.text('T/W Name     : ${data[0]['tw_name']}');
  }
